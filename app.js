...
var budgetController = (function() {
  ...
  return {
    ...
    calculateBudget: function() {
      // caculate expenses and income
      caculateTotal('exp')
      caculateTotal('inc')

      //caculate the budget: inc and exp
...
var UIController = (function() {
  ...
  return {
    ...
    clearFields: function() {
      ...
      fileds.forEach(function(current) {
        current.value = ""
      })
    ...
    displayMonth: function() {
      ...
      document.querySelector(DOMstrings.monthAndYear).textContent = months[month] + ' ' + year
    },
